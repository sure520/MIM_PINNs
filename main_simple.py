...
def parse_args():
    ...
    parser.add_argument('--epochs', type=int, default=2000, help='每个同伦步骤的训练轮数')  # 增加训练轮数
    parser.add_argument('--n_homotopy_steps', type=int, default=5, help='同伦步骤数')
    ...
    parser.add_argument('--max_solutions', type=int, default=2, help='最大求解数量')
...
def main():
    ...
    if len(all_solutions) > 0:
        ...
        visualizer.plot_solutions(models, all_omega2, ks, args.T, args.v)
